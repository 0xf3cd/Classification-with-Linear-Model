...
// const LinearRegression& LinearRegression::operator=(const LinearRegression & LR) {
//     auto LRDS = *(LR.pDS);
//     this->pDS = LRDS.duplicate();

//     this->coef = std::vector<double>(LR.coef);
//     this->bias = LR.bias;
//     this->alpha = LR.alpha;
//     this->iter = LR.iter;
//     this->cost_threshold = LR.cost_threshold;
